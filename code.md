...
csv_filename = os.path.join(csv_location, 'composites1.csv')
composites_directory = os.path.join(csv_location, 'composites1')
...
with open(csv_filename, 'r') as csv_file:
    ...
    for row in csv_reader:
        ...
        entry = {
            ...
            'diameter': round(float(row['diameter']), 4),
            'perimeter': round(float(row['perimeter']), 4),
